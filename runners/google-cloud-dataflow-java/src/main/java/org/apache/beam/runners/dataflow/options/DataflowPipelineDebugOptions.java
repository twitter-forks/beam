...
public interface DataflowPipelineDebugOptions extends ExperimentalOptions, PipelineOptions {
  ...
  /**
   * [EXPERIMENTAL] Set to false to disable automatic state cleanup timers for Stateful DoFns. This
   * reduces overhead and extra timers if the DoFn already sets timers in which all state is cleaned
   * up manually.
   */
  @Description(
